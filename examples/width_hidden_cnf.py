...
if __name__ == '__main__':
    ...
    for width in widths:
        ...
        if args.viz:
            ...
            results_dir = f"./resultss_circles_{width}"
    ...
    for hidden_dim in hidden_dims:
        ...
        if args.viz:
            # Create a unique results directory for each run
            results_dir = f"./resultss_circles_hidden_{hidden_dim}"
            if not os.path.exists(results_dir):
                os.makedirs(results_dir)
    ...
    plt.savefig('merged_sample_width_plot_circles_f.pdf', bbox_inches='tight', pad_inches=0)
    ...
    plt.axis('off')
    # Save the merged plot as a PDF
    plt.savefig('merged_log_width_plot_circles_f.pdf', bbox_inches='tight', pad_inches=0)
    ...
    plt.axis('off')
    # Save the merged plot as a PDF
    plt.savefig('merged_sample_hidden_plot_circles_f.pdf', bbox_inches='tight', pad_inches=0)
    ...
    plt.axis('off')
    # Save the merged plot as a PDF
    plt.savefig('merged_log_hidden_plot_circles_f.pdf', bbox_inches='tight', pad_inches=0)
